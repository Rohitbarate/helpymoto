...
import { serviceTypes, vehicleTypes } from "../../components/data/DATA";
  ...
  return (
    ...
    >
      <ScrollView
        ...
        style={{width:'95%',paddingRight:10,alignSelf:'center'}}
      >
      ...
      <View style={styles.hireDrDiv}>
        ...
        >
          <Text style={{ fontSize: 18, fontWeight: "900",color:'#000' }}>Need Driver?</Text>
          <TouchableOpacity
